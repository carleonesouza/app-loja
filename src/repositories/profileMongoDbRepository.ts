...
export class ProfileMongoDbRepository extends DbMongooseRepository<Profile> implements ProfileRepository {
    ...
    public async updateProfileById(profileId: string, profile: Profile): Promise<any> {
        try {
